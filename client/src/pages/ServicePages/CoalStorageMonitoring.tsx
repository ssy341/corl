...
export default function CoalStorageMonitoring() {
  ...
  // Set document title
  useEffect(() => {
    document.title = language === 'cn' ? '煤仓监管服务 | 煤炭服务' : 'Coal Storage Monitoring | Coal Services';
  }, [language]);
    ...
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              {language === 'cn' ? '煤仓监管服务' : 'Coal Storage Monitoring Service'}
            </h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl font-bold mb-6">
                  {language === 'cn' ? '全方位煤仓监管解决方案' : 'Comprehensive Coal Storage Monitoring Solution'}
                </h2>
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h3 className="font-medium">
                        {language === 'cn' ? '24/7 实时监控' : '24/7 Real-time Monitoring'}
                      </h3>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h3 className="font-medium">
                        {language === 'cn' ? '智能安全警报' : 'Intelligent Security Alerts'}
                      </h3>
                      <p className="text-sm text-gray-600">
                        {language === 'cn' 
                          ? '自动检测并报告可疑活动和异常情况' 
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h3 className="font-medium">
                        {language === 'cn' ? '高级数据分析' : 'Advanced Data Analytics'}
                      </h3>
                      <p className="text-sm text-gray-600">
                        {language === 'cn' 
                          ? '深入分析监控数据，提供可行见解' 
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">
                {language === 'cn' ? '尖端监控技术' : 'Cutting-edge Monitoring Technologies'}
              </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <Card className="border border-gray-200 shadow-sm hover:shadow-md transition-all">
                <CardHeader>
                  ...
                  <CardTitle>
                    {language === 'cn' ? '智能视频监控' : 'Smart Video Surveillance'}
                  </CardTitle>
                  <CardDescription>
                    {language === 'cn' 
                      ? '采用人工智能分析的高清摄像系统' 
              ...
              <Card className="border border-gray-200 shadow-sm hover:shadow-md transition-all">
                <CardHeader>
                  ...
                  <CardTitle>
                    {language === 'cn' ? '热成像与温度感应' : 'Thermal Imaging & Temperature Sensing'}
                  </CardTitle>
                  <CardDescription>
                    {language === 'cn' 
                      ? '监控煤堆温度变化预防自燃' 
              ...
              <Card className="border border-gray-200 shadow-sm hover:shadow-md transition-all">
                <CardHeader>
                  ...
                  <CardTitle>
                    {language === 'cn' ? '库存与变动分析' : 'Inventory & Movement Analytics'}
                  </CardTitle>
                  <CardDescription>
                    {language === 'cn' 
                      ? '追踪煤炭库存水平和移动情况' 
      ...
      <section className="py-16" id="implementation">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">
                {language === 'cn' ? '实施流程' : 'Implementation Process'}
              </h2>
              <p className="text-gray-600 max-w-2xl mx-auto">
                {language === 'cn' 
              ...
              <div className="space-y-12 relative">
                ...
                <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
                  <div className="md:w-1/2 md:text-right order-2 md:order-1">
                    <h3 className="text-xl font-bold mb-3">
                      {language === 'cn' ? '1. 站点评估与需求分析' : '1. Site Assessment & Requirements Analysis'}
                    </h3>
                    <p className="text-gray-600">
                      {language === 'cn' 
                ...
                <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
                  ...
                  <div className="md:w-1/2 md:text-left order-3">
                    <h3 className="text-xl font-bold mb-3">
                      {language === 'cn' ? '2. 系统设计与规划' : '2. System Design & Planning'}
                    </h3>
                    <p className="text-gray-600">
                      {language === 'cn' 
                ...
                <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
                  <div className="md:w-1/2 md:text-right order-2 md:order-1">
                    <h3 className="text-xl font-bold mb-3">
                      {language === 'cn' ? '3. 设备安装与配置' : '3. Equipment Installation & Configuration'}
                    </h3>
                    <p className="text-gray-600">
                      {language === 'cn' 
                ...
                <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
                  ...
                  <div className="md:w-1/2 md:text-left order-3">
                    <h3 className="text-xl font-bold mb-3">
                      {language === 'cn' ? '4. 培训与持续支持' : '4. Training & Ongoing Support'}
                    </h3>
                    <p className="text-gray-600">
                      {language === 'cn' 
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <Card className="overflow-hidden">
                ...
                <CardHeader>
                  <CardTitle>
                    {language === 'cn' ? '大型矿业公司煤仓安全升级' : 'Large Mining Operation Security Upgrade'}
                  </CardTitle>
                  <CardDescription>
                    {language === 'cn' ? '解决煤炭盗窃和安全挑战' : 'Addressing coal theft and security challenges'}
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-600">
                ...
                <CardFooter>
                  <Button variant="link" className="px-0 text-primary">
                    {language === 'cn' ? '阅读详情' : 'Read full case study'} →
                  </Button>
                </CardFooter>
              </Card>
              ...
              <Card className="overflow-hidden">
                ...
                <CardHeader>
                  <CardTitle>
                    {language === 'cn' ? '发电厂煤炭自燃预防系统' : 'Power Plant Combustion Prevention System'}
                  </CardTitle>
                  <CardDescription>
                    {language === 'cn' ? '利用热成像技术预防煤炭自燃' : 'Using thermal imaging to prevent coal spontaneous combustion'}
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-600">
      ...
      <section className="py-16 bg-gradient-to-r from-slate-900 to-slate-800 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4">
            {language === 'cn' ? '准备升级您的煤仓监管系统？' : 'Ready to Upgrade Your Coal Storage Monitoring?'}
          </h2>
