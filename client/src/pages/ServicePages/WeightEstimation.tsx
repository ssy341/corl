    ...
    <div className="min-h-screen">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="bg-white p-8 rounded-lg shadow-md border border-gray-100">
                ...
                <ul className="mt-4 space-y-2">
                  <li className="flex items-center">
                    <span className="text-green-500 mr-2">✓</span>
                    <span className="text-gray-700">
                      {i18n.language === 'cn' ? '无需停止煤场运营' : 'No need to stop coal yard operations'}
                    </span>
                  </li>
                  <li className="flex items-center">
                    <span className="text-green-500 mr-2">✓</span>
                    <span className="text-gray-700">
                      {i18n.language === 'cn' ? '显著减少测量时间' : 'Significantly reduce measurement time'}
                    </span>
                  </li>
                  <li className="flex items-center">
                    <span className="text-green-500 mr-2">✓</span>
                    <span className="text-gray-700">
                      {i18n.language === 'cn' ? '降低人力资源成本' : 'Lower human resource costs'}
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white p-8 rounded-lg shadow-md border border-gray-100">
                ...
                <h3 className="text-xl font-bold mb-4">
                  {i18n.language === 'cn' ? '优化库存管理' : 'Optimize Inventory Management'}
                </h3>
                <p className="text-gray-600">
                  {i18n.language === 'cn' 
                ...
                <ul className="mt-4 space-y-2">
                  <li className="flex items-center">
                    <span className="text-green-500 mr-2">✓</span>
                    <span className="text-gray-700">
                      {i18n.language === 'cn' ? '实时库存水平监控' : 'Real-time inventory level monitoring'}
                    </span>
                  </li>
                  <li className="flex items-center">
                    <span className="text-green-500 mr-2">✓</span>
                    <span className="text-gray-700">
                      {i18n.language === 'cn' ? '数据驱动的采购决策' : 'Data-driven purchasing decisions'}
                    </span>
                  </li>
                  <li className="flex items-center">
                    <span className="text-green-500 mr-2">✓</span>
                    <span className="text-gray-700">
                      {i18n.language === 'cn' ? '识别潜在的库存损失' : 'Identify potential inventory losses'}
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white p-8 rounded-lg shadow-md border border-gray-100">
                ...
                <h3 className="text-xl font-bold mb-4">
                  {i18n.language === 'cn' ? '增强合规性与透明度' : 'Enhance Compliance & Transparency'}
                </h3>
                <p className="text-gray-600">
                  {i18n.language === 'cn' 
                ...
                <ul className="mt-4 space-y-2">
                  <li className="flex items-center">
                    <span className="text-green-500 mr-2">✓</span>
                    <span className="text-gray-700">
                      {i18n.language === 'cn' ? '符合国际标准的测量' : 'Measurements compliant with international standards'}
                    </span>
                  </li>
                  <li className="flex items-center">
                    <span className="text-green-500 mr-2">✓</span>
                    <span className="text-gray-700">
                      {i18n.language === 'cn' ? '可审计的数据报告' : 'Auditable data reports'}
                    </span>
                  </li>
                  <li className="flex items-center">
                    <span className="text-green-500 mr-2">✓</span>
                    <span className="text-gray-700">
                      {i18n.language === 'cn' ? '强有力的争议解决证据' : 'Strong evidence for dispute resolution'}
                    </span>
                  </li>
                </ul>
              </div>
      ...
      <section className="py-16 bg-gray-50" id="how-it-works">
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">
                {i18n.language === 'cn' ? '服务流程' : 'How It Works'}
              </h2>
              <p className="text-gray-600 max-w-2xl mx-auto">
                {i18n.language === 'cn' 
                  ? '我们的煤重估算服务流程简单高效' 
            ...
            <div className="relative">
              ...
              <div className="space-y-12">
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-3">
                      {i18n.language === 'cn' ? '初步评估与规划' : 'Initial Assessment & Planning'}
                    </h3>
                    <p className="text-gray-600 mb-4">
                      {i18n.language === 'cn' 
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-3">
                      {i18n.language === 'cn' ? '数据采集' : 'Data Collection'}
                    </h3>
                    <p className="text-gray-600 mb-4">
                      {i18n.language === 'cn' 
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-3">
                      {i18n.language === 'cn' ? '数据处理与分析' : 'Data Processing & Analysis'}
                    </h3>
                    <p className="text-gray-600 mb-4">
                      {i18n.language === 'cn' 
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-3">
                      {i18n.language === 'cn' ? '报告生成与交付' : 'Report Generation & Delivery'}
                    </h3>
                    <p className="text-gray-600 mb-4">
                      {i18n.language === 'cn' 
      ...
      <section className="py-16" id="testimonials">
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">
                {i18n.language === 'cn' ? '客户评价' : 'Client Testimonials'}
              </h2>
              <p className="text-gray-600 max-w-2xl mx-auto">
                {i18n.language === 'cn' 
                  ? '听听我们客户对煤重估量服务的评价' 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    <h4 className="font-bold">
                      {i18n.language === 'cn' ? '张经理' : 'Manager Zhang'}
                    </h4>
                    <p className="text-sm text-gray-600">
                      {i18n.language === 'cn' ? '大型煤矿企业' : 'Large Coal Mining Enterprise'}
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-white p-8 rounded-lg shadow-md border border-gray-100">
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    <h4 className="font-bold">
                      {i18n.language === 'cn' ? '李总监' : 'Director Li'}
                    </h4>
                    <p className="text-sm text-gray-600">
                      {i18n.language === 'cn' ? '电力集团' : 'Power Group'}
                    </p>
                  </div>
                </div>
                <p className="text-gray-700 italic mb-4">
      ...
      <section className="py-16 bg-gradient-to-r from-slate-900 to-slate-800 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4">
            {i18n.language === 'cn' ? '准备提升您的煤炭测量精度？' : 'Ready to Improve Your Coal Measurement Accuracy?'}
          </h2>
